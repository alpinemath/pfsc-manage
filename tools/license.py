...
def oca(image, dump=False, verbose=False):
    ...
    javascript_packages = '\n'.join(
        ...
        for pkg in js_comp if pkg.name not in [
            # Don't repeat packages that already got special mention.
            'pfsc-ise', 'mathjax', '@alpinemath/tmp-elk-fork',
            'pyodide', 'pdf.js',
        ]
    )
...
class SoftwarePackage:
    ...
    def get_src_url(self):
        if self.src_url and not self.gh_url:
            return self.src_url
        path_ext = (
            '' if (self.v is None or self.version.startswith('commit-'))
    ...
    def write_two_column_text_row(self, license_tab_stop=56):
        name_vers = f'{self.name} {self.version}'
        return name_vers + (' ' * (license_tab_stop - len(name_vers))) + self.license_name
...
MANUAL_PY_PKG_INFO = {
    ...
    r'github\.com/alpinemath/sympy': PyPackage(
        name='sympy',
        version="(Alpine Mathematics' fork v0.10.3)",
        gh_url='https://github.com/alpinemath/sympy',
        license_name='BSD',
        license_url='https://github.com/sympy/sympy/blob/master/LICENSE',
        v=None,
    ),
    r'github\.com/alpinemath/pfsc-examp': PyPackage(
        name='pfsc-examp',
        version='0.22.7',
        gh_url='https://github.com/alpinemath/pfsc-examp',
        license_name='Apache 2.0',
        license_url='https://www.apache.org/licenses/LICENSE-2.0.txt',
    ),
    r'github\.com/alpinemath/pfsc-util': PyPackage(
        name='pfsc-util',
        version='0.22.7',
        gh_url='https://github.com/alpinemath/pfsc-util',
        license_name='Apache 2.0',
        license_url='https://www.apache.org/licenses/LICENSE-2.0.txt',
    ),
    'aenum': {
...
PYODIDE_PKG_INFO = {
    ...
    'sympy': MANUAL_PY_PKG_INFO[r'github\.com/alpinemath/sympy'],
    'pfsc-examp': MANUAL_PY_PKG_INFO[r'github\.com/alpinemath/pfsc-examp'],
    'displaylang': PyPackage(
        name='displaylang',
        version='0.22.7',
        gh_url='https://github.com/alpinemath/displaylang',
        license_name='Apache 2.0',
        license_url='https://www.apache.org/licenses/LICENSE-2.0.txt',
        v=None,
    ),
    ...
    'pfsc-util': MANUAL_PY_PKG_INFO[r'github\.com/alpinemath/pfsc-util'],
...
OTHER_PKG_INFO = {
    'pdfjs': JsPackage(
        name='pdf.js',
        version="(Alpine Mathematics' fork v2.0.0)",
        gh_url='https://github.com/alpinemath/pfsc-pdf',
        license_name='Apache 2.0',
        license_url='https://www.apache.org/licenses/LICENSE-2.0.txt',
        v=None,
    ),
